 ...
 *   还有 Struts2 的拦截器、JSP 和 Servlet 的 Filter 等，所有这些，都可以考虑使用责任链模式来实现。
 *
 * 模式的定义与特点:
 ...
 *
 *   其结构图如图 chain_1.jpg 所示。客户端可按图 chain_2.jpg 所示设置责任链。
 *
 *   2. 模式的实现 {@link org.wmc.behavior.chain.ChainOfResponsibilityPatternMain}
 *
 * 模式的应用实例:
 *   用责任链模式设计一个请假条审批模块 {@link org.wmc.behavior.chain.leaveapprove.LeaveApprovalMain}
 *
 * 模式的应用场景:
