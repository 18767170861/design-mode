 ...
 *   学生和老师来到学校的教学区，都会注意学校的铃，这叫事件绑定；当上课时间或下课时间到，会触发铃发声，这时会生成“铃声”事件；
 *   学生和老师听到铃声会开始上课或下课，这叫事件处理。这个实例非常适合用观察者模式实现，图 ring.jpg 给出了学校铃声的事件模型。
 *
 ...
 *   图 ring_structure.jpg 给出了学校铃声事件处理程序的结构。
 *
 *
 *
 *
