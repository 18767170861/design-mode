 ...
 *
 * 原型模式的应用实例 {@link org.wmc.create.prototype.sunwukong.ProtoTypeWukong, org.wmc.build.prototype.citation.ProtoTypeCitation}
 *
 * 原型模式的应用场景:
 *    原型模式通常适用于以下场景。
 ...
 *    其结构图如图 prototypeExtend.jpg 所示。
 *    原型模式的扩展实例 {@link org.wmc.create.prototype.extend.ProtoTypeShapeMain}
 */
